...
final class Bootstrap {
    ...
    public static function has_access() : bool {
        if ( is_plugin_active( 'dev-debug-tools/dev-debug-tools.php' ) && class_exists( '\Apos37\DevDebugTools\Helpers' ) ) {
    ...
    public static function settings_url() : string {
        return self::admin_url( 'options-general.php?page=prxagnt-settings' );
    } // End settings_url()
