...
class Updater {
    ...
    public function pre_check( $transient ) {
        ...
        if ( version_compare( $current_version, $remote_version, '<' ) &&
            ...
            // error_log(
            //     $this->args[ 'name' ] . ': No update applied. ' .
            //     'Current: ' . $current_version .
            //     ', Remote: ' . $remote_version .
            //     ', WP Req: ' . $requires_wp .
            //     ', PHP Req: ' . $requires_php, 0
            // ); // phpcs:ignore
        }
        return $transient;
    } // End pre_check()
    ...
    public function license_update_notice() {
        echo '<div class="notice notice-error"><p>' . wp_kses( sprintf( __( 'Plugin updates are disabled because your %1$s license is invalid. Please enter a valid license key in the <a href="%2$s">settings</a>.', 'pluginrx-agent' ),
