...
class PluginPage {
     ...
     * @var string
     */
    private $plugin_file = 'pluginrx-agent/pluginrx-agent.php';
    ...
    public function plugin_row_meta( $links, $file ) {
        ...
        $our_links   = [
            // 'guide' => [ // TODO:
            //     'label' => __( 'How-To Guide', 'pluginrx-agent' ),
            //     'url'   => "{$base_url}guide/plugin/{$this->text_domain}",
            // ],
            // 'docs' => [
            //     'label' => __( 'Developer Docs', 'pluginrx-agent' ),
            //     'url'   => "{$base_url}docs/plugin/{$this->text_domain}",
            // ],
            'support' => [
                'label' => __( 'Support', 'pluginrx-agent' ),
    ...
    public function add_settings_link( $links ) {
        ...
        $settings_link = sprintf(
            '<a href="%s">%s</a>',
            esc_url( $url ),
            esc_html__( 'Settings', 'pluginrx-agent' )
        );
